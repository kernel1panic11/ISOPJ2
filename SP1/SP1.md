...
<main class="contenedor-principal">
    ...
    <div class="content-section">
        ...
        <p>
            Además de instalar el sistema, será necesario documentar el proceso con capturas de pantalla colocadas en el punto exacto donde se explica cada acción. De este modo, la práctica no solo muestra el resultado final, sino también la evidencia visual de cada paso importante: creación de la máquina virtual, instalación del sistema, activación, red, software base y comprobaciones de arranque. :contentReference[oaicite:0]{index=0}
        </p>
    </div>
    ...
    <div class="content-section">
        ...
        <p>
            Una vez creada la máquina virtual, se asocia la imagen ISO de Windows 11 a la unidad virtual correspondiente para que el sistema pueda arrancar desde ella e iniciar el asistente de instalación.
        </p>
        <p>
            Debajo de este texto debe colocarse una captura donde se vea la ISO configurada en VMware, normalmente dentro de la configuración del dispositivo CD/DVD virtual. La imagen debe servir como prueba de que el medio de instalación ha sido cargado correctamente antes del arranque.
        </p>
        <div class="capture-placeholder">
            <p><strong>[Insertar aquí la captura del paso 3: ISO de Windows 11 cargada en VMware]</strong></p>
        </div>

        <h3>Paso 4. Justificar la configuración elegida</h3>
        <p>
            En este punto se debe explicar por qué la configuración seleccionada resulta adecuada para el entorno de trabajo planteado. Asignar una cantidad razonable de memoria, un disco suficiente y una red funcional permite instalar y usar Windows 11 con estabilidad, manteniendo además un equilibrio con los recursos disponibles en el equipo anfitrión.
        </p>
        <p>
            Debajo de este apartado conviene colocar una captura adicional de la configuración general de la máquina virtual en VMware. Esta imagen refuerza la explicación y deja constancia visual de los parámetros adoptados antes de comenzar la instalación.
        </p>
        <div class="capture-placeholder">
            <p><strong>[Insertar aquí la captura del paso 4: configuración general de la máquina virtual]</strong></p>
        </div>

        <h3>Paso 5. Verificar que la máquina está lista para arrancar</h3>
        <p>
            Antes de comenzar la instalación, se comprueba que la máquina virtual ha quedado correctamente preparada, con su hardware configurado, el disco virtual creado y la ISO asociada al arranque. Esta verificación cierra la fase de preparación.
        </p>
        <p>
            Debajo de este texto debe colocarse una captura general de VMware donde se vea la máquina preparada para iniciarse. La imagen debe actuar como evidencia de que el entorno está listo para comenzar la instalación de Windows 11.
        </p>
        <div class="capture-placeholder">
            <p><strong>[Insertar aquí la captura del paso 5: máquina virtual preparada para arrancar en VMware]</strong></p>
        </div>
    </div>
</main>
